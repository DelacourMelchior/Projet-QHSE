...
import { Info, Quote, TrendingDown, Users, AlertTriangle, Clock, Target, Anchor, TrendingUp, ShieldCheck, Zap, Layout, Check, RotateCcw } from 'lucide-react';
        ...
        <div className="flex flex-col lg:flex-row gap-6 h-[850px]">
          ...
          {step > 0 && step < 12 && (
            ...
            <div className="space-y-8 flex-grow overflow-y-auto pr-2 custom-scrollbar">
              ...
              {step === 13 && (
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="bg-white p-6 rounded-lg border border-gray-200 shadow-sm">
                  <h3 className="font-serif text-xl text-sb-green-dark mb-4">Proposition d'audit</h3>
                  <p className="font-sans text-sm text-gray-700">Voici la proposition d'audit basée sur vos saisies. Vous pouvez imprimer ce document PDF pour le partager.</p>
                </motion.div>
              )}
                ...
                >
                  ...
                  <div className="text-center pt-8">
                    <button 
                      ...
                      className="px-12 py-6 bg-sb-green-dark text-white font-bold uppercase tracking-widest rounded shadow-2xl hover:bg-sb-green-dark/90 transition-all transform hover:-translate-y-1"
                    >
