  ...
  return (
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center bg-sb-green-dark overflow-hidden">
        {/* Background - Intense/Focus Aesthetic */}
      ...
      <Section bg="cream" className="py-fib-144">
        <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
                <h2 className="font-serif text-3xl md:text-title text-sb-green-dark uppercase tracking-math-tight mb-8">L'Épreuve du Réel</h2>
                <div className="relative p-10 bg-white border-l-4 border-[#8B0000] shadow-sm rounded-[2px]">
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-16">
                {/* Pain Point 1 */}
                <div className="bg-white p-8 border border-gray-200 hover:border-[#8B0000]/30 transition-all duration-300 group rounded-[2px]">
                    <div className="w-12 h-12 bg-sb-cream text-[#8B0000] flex items-center justify-center rounded-[2px] mb-6 group-hover:bg-[#8B0000] group-hover:text-white transition-colors">
                        <AlertOctagon size={24} />
                    </div>
                    <h3 className="font-serif text-xl font-bold text-sb-green-dark mb-4">L'Angle Mort</h3>
                    <p className="text-sb-green-dark/70 font-light leading-phi text-sm">
                        Ces détails normatifs que vous ne voyez plus et qui deviendront des non-conformités bloquantes le jour de l'audit.
                    </p>
                </div>
                ...
                <div className="bg-white p-8 border border-gray-200 hover:border-[#8B0000]/30 transition-all duration-300 group rounded-[2px]">
                    ...
                    <h3 className="font-serif text-xl font-bold text-sb-green-dark mb-4">Le Facteur Stress</h3>
                    <p className="text-sb-green-dark/70 font-light leading-phi text-sm">
                ...
                <div className="bg-white p-8 border border-gray-200 hover:border-[#8B0000]/30 transition-all duration-300 group rounded-[2px]">
                    ...
                    <h3 className="font-serif text-xl font-bold text-sb-green-dark mb-4">L'Urgence Finale</h3>
                    <p className="text-sb-green-dark/70 font-light leading-phi text-sm">
                        Découvrir les écarts trop tard pour les corriger. Le risque de devoir repousser la certification et perdre vos marchés.
                    </p>
                </div>
            </div>
        </div>
      ...
      <Section bg="green" className="py-fib-144 relative border-t-4 border-sb-beige">
        <div className="text-center mb-24">
            <h2 className="font-serif text-title text-white uppercase tracking-math-tight mb-4">Le Protocole</h2>
            <p className="text-sb-beige font-sans uppercase tracking-math-wide text-sm">Simuler pour Réussir</p>
        </div>
            ...
            <div className="space-y-20">
                ...
                <div className="relative flex flex-col md:flex-row items-center justify-between w-full group">
                    <div className="md:w-5/12 text-left md:text-right pl-12 md:pl-0 md:pr-12 order-2 md:order-1">
                        <h3 className="font-serif text-2xl text-sb-beige mb-2">Immersion Totale</h3>
                        <p className="text-white/70 font-light leading-phi text-sm">Simulation d'audit en conditions réelles (2 à 5 jours selon périmètre). Nous adoptons la posture de l'auditeur de certification.</p>
                    </div>
                ...
                <div className="relative flex flex-col md:flex-row items-center justify-between w-full group">
                    ...
                    <div className="absolute left-4 md:left-1/2 -translate-x-1/2 w-8 h-8 bg-sb-green-dark border-2 border-sb-beige rounded-full flex items-center justify-center z-10 order-1 md:order-2">
                        <AlertOctagon size={14} className="text-sb-beige" />
                    </div>
                    <div className="md:w-5/12 text-left pl-12 order-2 md:order-3">
                        <h3 className="font-serif text-2xl text-sb-beige mb-2">Cartographie des Écarts</h3>
                        <p className="text-white/70 font-light leading-phi text-sm">Identification factuelle de tous les écarts normatifs. Priorisation immédiate des points critiques (Non-Conformités Majeures).</p>
                    </div>
                </div>
                 ...
                 <div className="relative flex flex-col md:flex-row items-center justify-between w-full group">
                    <div className="md:w-5/12 text-left md:text-right pl-12 md:pl-0 md:pr-12 order-2 md:order-1">
                        <h3 className="font-serif text-2xl text-sb-beige mb-2">Plan d'Action Commando</h3>
                        <p className="text-white/70 font-light leading-phi text-sm">Livraison immédiate des actions correctives à mener avant l'audit officiel. Accompagnement sur les dossiers sensibles.</p>
                    </div>
                    <div className="absolute left-4 md:left-1/2 -translate-x-1/2 w-8 h-8 bg-sb-green-dark border-2 border-sb-beige rounded-full flex items-center justify-center z-10 order-1 md:order-2">
                ...
                <div className="relative flex flex-col md:flex-row items-center justify-between w-full group">
                    ...
                    <div className="md:w-5/12 text-left pl-12 order-2 md:order-3">
                        <h3 className="font-serif text-2xl text-sb-beige mb-2">Postures & Coaching</h3>
                        <p className="text-white/70 font-light leading-phi text-sm">Entraînement des pilotes de processus à la réponse et à la démonstration d'efficacité pour rassurer l'auditeur.</p>
                    </div>
                </div>
            </div>
        </div>
      ...
      <Section bg="cream" className="py-24 text-center border-t border-sb-green-dark/10">
        ...
        >
            DEMANDER UN DEVIS D'AUDIT BLANC <ArrowRight size={18} className="ml-3 group-hover:translate-x-1 transition-transform" />
        </button>
      </Section>
    </>
  );
