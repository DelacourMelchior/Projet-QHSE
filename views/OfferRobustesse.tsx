    ...
    <>
        ...
        <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6 md:gap-8 mt-16 px-2 md:px-0">
                ...
                <div className="bg-white p-6 md:p-8 border border-gray-200 rounded-[2px] group">
                    ...
                    <h3 className="font-serif text-lg md:text-xl font-bold text-sb-green-dark mb-4">Asymétrie de perception</h3>
                ...
                <div className="bg-white p-6 md:p-8 border border-gray-200 rounded-[2px] group">
                    ...
                    <h3 className="font-serif text-lg md:text-xl font-bold text-sb-green-dark mb-4">Risque de disqualification</h3>
                    <p className="text-sb-green-dark/70 font-light leading-phi text-sm">
                ...
                <div className="bg-white p-6 md:p-8 border border-gray-200 rounded-[2px] group">
                    ...
                    <h3 className="font-serif text-lg md:text-xl font-bold text-sb-green-dark mb-4">Volatilité opérationnelle</h3>
                    <p className="text-sb-green-dark/70 font-light leading-phi text-sm">
      ...
      <Section bg="green" className="py-20 md:py-fib-144 relative border-t-4 border-sb-beige">
        <div className="text-center mb-24 px-4">
            ...
            <p className="text-sb-beige font-sans uppercase tracking-math-wide text-[10px] md:text-sm">Processus d'Investigation</p>
        </div>
            ...
            <div className="space-y-16 md:space-y-24">
                ...
                <div className="relative flex flex-col md:flex-row items-center justify-between w-full group">
                    <div className="md:w-5/12 text-left md:text-right pl-12 md:pl-0 md:pr-12 order-2 md:order-1">
                        <h3 className="font-serif text-lg md:text-2xl text-sb-beige mb-2">Phase 1 : Cadrage</h3>
                        <p className="text-sb-beige/60 text-[10px] font-bold uppercase tracking-wide mb-2">Off-Site</p>
                        <p className="text-white/70 font-light leading-phi text-xs md:text-sm">Analyse des Pré-requis et cartographie des standards incontournables de votre marché pour préparer l'intervention.</p>
                    </div>
                ...
                <div className="relative flex flex-col md:flex-row items-center justify-between w-full group">
                    ...
                    <div className="absolute left-6 md:left-1/2 -translate-x-1/2 w-6 h-6 bg-sb-green-dark border-2 border-sb-beige rounded-full flex items-center justify-center z-10 order-1 md:order-2">
                         <Zap size={12} className="text-sb-beige" />
                    </div>
                    <div className="md:w-5/12 text-left pl-12 order-2 md:order-3">
                        <h3 className="font-serif text-lg md:text-2xl text-sb-beige mb-2">Phase 2 : Immersion</h3>
                        <p className="text-sb-beige/60 text-[10px] font-bold uppercase tracking-wide mb-2">On-Site</p>
                        <p className="text-white/70 font-light leading-phi text-xs md:text-sm">Audit des Flux et évaluation in-situ de la résilience de vos processus face à des scénarios critiques.</p>
                    </div>
                </div>
                 ...
                 <div className="relative flex flex-col md:flex-row items-center justify-between w-full group">
                    <div className="md:w-5/12 text-left md:text-right pl-12 md:pl-0 md:pr-12 order-2 md:order-1">
                        <h3 className="font-serif text-lg md:text-2xl text-sb-beige mb-2">Phase 3 : Feuille de Route</h3>
                        <p className="text-sb-beige/60 text-[10px] font-bold uppercase tracking-wide mb-2">Restitution</p>
                        <p className="text-white/70 font-light leading-phi text-xs md:text-sm">Remise du Rapport d'Étonnement et du Plan Directeur. Nous livrons une feuille de route priorisée.</p>
                    </div>
                    <div className="absolute left-6 md:left-1/2 -translate-x-1/2 w-6 h-6 bg-sb-green-dark border-2 border-sb-beige rounded-full flex items-center justify-center z-10 order-1 md:order-2">
      ...
      <Section bg="cream" className="py-24 text-center border-t border-sb-green-dark/10 px-4">
        ...
        >
            RÉSERVER MON AUDIT DE ROBUSTESSE <ArrowRight size={16} className="ml-3 group-hover:translate-x-1 transition-transform" />
        </button>
      </Section>
    </>
  );
